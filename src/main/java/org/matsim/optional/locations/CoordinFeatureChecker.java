package org.matsim.optional.locations;
...
public class CoordinFeatureChecker {
	...
	public static void main(String[] args) {
		String shapeFile = "../matsim-dresden/input/shp/gem_25832.shp"; // Gemeinden in Sachsen
		...
		Id<Link> linkId = Id.createLinkId("572364039"); // Hettnerstraße aus VIA
		Link link = network.getLinks().get(linkId);

		String featureId = "14612000"; // Gemeindekennzahl von Dresden
	...
	public boolean checkIfLinkInFeature(Link link, String featureId){ // Man kann sowas auch für Aktivitäten machen (statt link -> activity)
